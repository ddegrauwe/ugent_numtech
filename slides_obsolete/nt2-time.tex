...
\begin{frame}
	...
	\begin{minipage}[t]{.65\textwidth}
		\only<1>{\vspace*{0pt}\scalebox{.75}{\input{./figures/nt2/amp_damp}}}%
		\only<2->{\vspace*{0pt}\scalebox{.75}{\input{./figures/nt2/acc_dec}}}
...
%
\begin{center}
	\scalebox{.95}{\input{./figures/nt2/2TLA}}
\end{center}
%
\end{frame}
%
...
%
\begin{center}
	\scalebox{.95}{\input{./figures/nt2/2TLR}}
\end{center}
%
\end{frame}
%
