...
\begin{frame}
	...
	\begin{center}
		...
		\begin{tabular}{l|lll}
			date	&	14h30	&	16h00	&	17h30 \\
		\hline
			03/10 	&	& Introduction, \\[-4pt]
					&	& Stability	\\
			10/10	&	& Time discretization		&	Practicum \\[-4pt]
					&	&							&	Oscillation equation	\\
			11/10	& 	Space 			&	Practicum \\[-4pt]
					&	discretization	&	Oscillation equation	\\[-4pt]
			17/10	&	& Spectral models			& 	Practicum\\[-4pt]
					&	&							&	Advection equation 		\\
			18/10	& 	Nontrivial	&	Practicum \\[-4pt]
					&	aspects		&	Advection equation		\\
			31/10	&	& Semi-Implicit \\[-4pt]
					&	& Semi-Lagrangian models \\
			14/11	&	& Parallel computing and \\[-4pt]
					&	& Project assignment \\
		\hline
			06/03	&	& Project support session	\\
			28/03	&	& Student project presentations
		\end{tabular}
		\def\arraystretch{1}
	\end{center}
	%
	Theory lessons at auditorium 3.1; practical sessions at PC room Konrad Suze
\end{frame}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
