...
\begin{frame}
    ...
    \begin{center}
        \vspace*{-1ex}
        \includegraphics[width=.75\textwidth]{instability}
    \end{center}
\end{frame}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
    ...
    \vspace*{-1ex}
	%
	Using a Taylor expansion\vspace*{1ex}
	%
	\begin{equation*}
		f(x_0+\Delta x) = f(x_0) +
	...
	\end{equation*}\par\vspace*{2ex}
	%
	the error in the approximation of the derivative is\vspace*{1ex}
	%
	\begin{equation*}
		\frac{f(x_0+\Delta x) - f(x_0)}{\Delta x}
		- \frac{d f}{dx} (x_0) =
...
\begin{frame}
	...
	%
	A scheme is called \emph{consistent} if the truncation error goes to zero when $\Delta x \rightarrow 0$ and $\Delta t \rightarrow 0$.
	%
	\par\vspace*{3ex}
