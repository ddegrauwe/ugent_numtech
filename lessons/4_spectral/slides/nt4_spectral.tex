...
\begin{frame}
	...
	\vfill\begin{itemize}
		\item Consider a periodic function $f(x)$ with period $2\pi$:
			%
			\begin{center}
				\scalebox{.6}{\small\input{./figures/decomp_GP}
				}
			\end{center}\vfill
			%
	...
	\vfill\begin{itemize}
		\item For example:\vspace*{2ex}
			...
			\hspace*{-10pt}\begin{tabular}{@{}r@{}c@{}c@{}c@{}c@{}c@{}c@{}}
				\scalebox{.35}{\small\input{./figures/decomp_GP}}\raisebox{8mm}{$=$}	& %
												&	\scalebox{.35}{\small\input{./figures/decomp_SP_0}}	&
						\raisebox{8mm}{$+$}	&	\scalebox{.35}{\small\input{./figures/decomp_SP_1}}	&
						\raisebox{8mm}{$+$}	&	\scalebox{.35}{\small\input{./figures/decomp_SP_2}}	\\
					&&	$k=0$	&&	$k=1$	&& $k=2$\\[4mm]
					&	\raisebox{8mm}{$+$}	&	\scalebox{.35}{\small\input{./figures/decomp_SP_3}}	&
						\raisebox{8mm}{$+$}	&	\scalebox{.35}{\small\input{./figures/decomp_SP_4}}	&
...
\begin{frame}
	...
	\vfill\begin{itemize}
		\item When plotting the spectral coefficients $\alpha_k$ against the wavenumbers, one obtains the \emph{spectrum} of the function $f(x)$:
			%
			\begin{center}
				\scalebox{.7}{\small\input{./figures/spectrum}}
			\end{center}\vfill
			%
...
\begin{frame}
	...
	\begin{center}
		\begin{tabular}{ccc}
			...
			\scalebox{.6}{\small\input{./figures/smoothfunc1}}&\quad\tikz[>=latex]{\useasboundingbox (.5,-1.5);\draw[<->] (0,0) -- (1,0);}\quad&%
			\scalebox{.6}{\small\input{./figures/smoothspec1}}\\[3ex]
			\scalebox{.6}{\small\input{./figures/smoothfunc2}}&\quad\tikz[>=latex]{\useasboundingbox (.5,-1.5);\draw[<->] (0,0) -- (1,0);}\quad&%
			\scalebox{.6}{\small\input{./figures/smoothspec2}}
		\end{tabular}
	\end{center}\vfill
	%
\end{frame}
...
\begin{frame}
	...
	\vfill\begin{itemize}
		\item When modeling a \emph{discontinuity} with harmonic functions, the approximation will contain \emph{overshoots}
			%
			\begin{center}
				\only<1>{\scalebox{1}{\small\input{./figures/gibbs1}}}%
				\only<2>{\scalebox{1}{\small\input{./figures/gibbs2}}}%
				\only<3>{\scalebox{1}{\small\input{./figures/gibbs3}}}%
				\only<4->{\scalebox{1}{\small\input{./figures/gibbs}}}
			\end{center}\vfill
			%
\onslide<4->{
...
\begin{frame}
	...
	%
	\begin{center}
		\scalebox{.95}{\small\input{./figures/derivaccur}}
	\end{center}
	%
\end{frame}
%
...
\begin{frame}
	...
	\vfill\begin{itemize}
		\item Sampling a wave with wavenumber $k=21$ on a grid with $K=12$, so $N=2K+1=25$ gridpoints:
			%
			\begin{center}
				\only<1>{\scalebox{.7}{\small\input{./figures/alias_1}}}%
				\only<2->{\scalebox{.7}{\small\input{./figures/alias_2}}}
			\end{center}\vfill
			%
\onslide<2->{
...
\begin{frame}
	...
	\vfill\begin{itemize}
		\item A different way to interpret aliasing is by considering the spectrum as periodic:
			%
			\begin{center}
				\only<1>{\scalebox{.7}{\small\input{./figures/alias_3}}}%
				\only<2>{\scalebox{.7}{\small\input{./figures/alias_4}}}%
				\only<3->{\scalebox{.7}{\small\input{./figures/alias_5}}}%
			\end{center}\vfill
			%
\onslide<3->{
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item In 2D, the resolution is not the same in all directions
			%
			\only<-1>{\scalebox{.7}{\small\input{./figures/2D}}}\vspace*{1ex}
			%
\onslide<2->{%
...
\begin{frame}
	...
	\begin{center}
		\hspace*{-10mm}%
		\scalebox{.3}{\includegraphics{figures/adv_1}}%
		\scalebox{.3}{\includegraphics{figures/adv_2}}
	\end{center}
\end{frame}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
