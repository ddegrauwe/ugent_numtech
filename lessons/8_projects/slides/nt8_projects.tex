...
\begin{frame}
	...
	\begin{myitemize}{2ex}
		...
		\item Pick a single topic (e.g. SWE-spectral); post your group + choice on Ufora forum.
			%
		\item Jupyter notebooks for SWE and BVE on\\ \texttt{https://github.com/ddegrauwe/ugent\_numtech/tree/main/projects}.
			%
		\item More detailed background info (papers) also on github.
			%
		\item Support sessions: \textbf{24 November and 1 December}, 16h00-18h00; come prepared!
			%
		\item Report (say 5--10 pp.): deadline Friday 5 December.
		\item Presentation for other students: Monday 8 December.
	\end{myitemize}
	%
\end{frame}
%
